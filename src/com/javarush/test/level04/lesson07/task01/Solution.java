...
public class Solution
{
    ...
    public static void CheckNum(int a) {
        if (a % 2 == 0){
            if (a < 0) System.out.print("отрицательное четное число");
            else System.out.print("положительное четное число"); }
        else {
            if (a < 0) System.out.print("отрицательное нечетное число");
